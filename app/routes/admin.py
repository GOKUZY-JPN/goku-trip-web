...
def seed():
    ...
    tours_data = [
        ...
        },
        {
            ...
            'description': "Discover the mystical beauty of Fushimi Inari Shrine at night on a guided walking tour. Stroll through the iconic vermilion torii gates in a quiet, uncrowded atmosphere and learn about the shrine's rich history.",
            'duration_hours': 2, 'max_capacity': 10, 'area': 'kyoto', 'price': 20700, 'start_time': '18:00',
            'image_url': 'https://images.unsplash.com/photo-1478436127897-769e1b3f0f36?w=800&q=80',
        },
        {
            'name': 'Kyoto: Nijo Castle & Imperial Palace Guided Tour',
            'description': "Explore Kyoto's rich history and culture on a guided walking tour. Visit Nijo Castle and the Kyoto Imperial Palace — two of Japan's most iconic landmarks. Learn about the political intrigues and architectural wonders of the past.",
        ...
        },
        {
            ...
            'description': "Explore the cultural heart of Japan on a private tour of Nara's iconic UNESCO World Heritage Sites. Feed the friendly sacred deer, visit Kasuga Grand Shrine, and marvel at the world's largest bronze Buddha statue inside Todai-ji Temple.",
            'duration_hours': 3, 'max_capacity': 8, 'area': 'nara', 'price': 20700, 'start_time': '09:00',
            'image_url': 'https://images.unsplash.com/photo-1594818379496-da1e345b0ded?w=800&q=80',
        },
        {
            'name': 'Kanazawa Castle & Kenroku-en Garden Tour',
            'description': "Experience the beauty of Kanazawa on a private walking tour with a veteran guide. Explore Kenroku-en Garden, Kanazawa Castle, the samurai district, and tea ceremony shops.",
            'duration_hours': 3, 'max_capacity': 8, 'area': 'kanazawa', 'price': 20700, 'start_time': '09:30',
            'image_url': 'https://images.unsplash.com/photo-1580619305218-8423a7ef79b4?w=800&q=80',
        },
        {
            ...
            'image_url': 'https://images.unsplash.com/photo-1589452271712-64b8a66c7b71?w=800&q=80',
        },
        {
            'name': 'Kyoto, Your Way: A Personalized 4-Hour Exploration',
            'description': "Shape your half-day in Kyoto with iconic landmarks, hidden gems, and serene paths — crafted by your local host to match what excites you most. Explore Gion's historic streets, Ishibei-koji Alley, Ninenzaka & Sannenzaka slopes, and the serene Shirakawa Canal.",
        ...
        },
        {
            ...
            'description': "Ease into Kyoto's rhythm with a thoughtful 3-hour introduction to its iconic sights, cultural nuances, and local tips — leaving you ready to explore with confidence.",
            'duration_hours': 3, 'max_capacity': 8, 'area': 'kyoto', 'price': 20700, 'start_time': '09:00',
        ...
        },
        {
            ...
            'description': "Discover Osaka's contrasts with a half-day experience blending iconic highlights and hidden gems. Explore Kuromon Market, Hozenji Yokocho, Dotonbori's neon wonderland, and the hidden Namba Yasaka Shrine.",
            'duration_hours': 4, 'max_capacity': 8, 'area': 'osaka', 'price': 20700, 'start_time': '09:00',
            'image_url': 'https://images.unsplash.com/photo-1590559899731-a382839e5549?w=800&q=80',
        },
        {
            'name': 'Half Day in Kobe with a Local',
            'description': "Discover Kobe's unique charm with a personalized half-day experience. Visit Ikuta Shrine, explore the beautiful seafront, discover hidden neighborhoods, and experience the city's famous food culture including Kobe beef.",
        ...
        },
        {
            ...
            'description': "Start with Nara's famous temples and deer park, then slip into peaceful streets and local life with your host. Visit Todai-ji Temple, stroll Nara Park among sacred deer, explore Kasuga Taisha Shrine, and discover Naramachi's preserved old merchant quarter.",
