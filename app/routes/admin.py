    ...
    tours_data = [
        {
            ...
            'duration_hours': 3, 'max_capacity': 6, 'area': 'uji',
            'price': 20700, 'start_time': '09:30',
        },
        {
            ...
            'duration_hours': 2, 'max_capacity': 10, 'area': 'kyoto',
            'price': 20700, 'start_time': '18:00',
        },
        {
            ...
            'duration_hours': 3, 'max_capacity': 8, 'area': 'kyoto',
            'price': 20700, 'start_time': '09:00',
        },
        {
            ...
            'duration_hours': 3, 'max_capacity': 8, 'area': 'nara',
            'price': 20700, 'start_time': '09:00',
        },
        {
            ...
            'duration_hours': 3, 'max_capacity': 8, 'area': 'kanazawa',
            'price': 20700, 'start_time': '09:30',
        },
        {
            'name': 'Himeji Castle: Expert Samurai History Tour',
            'description': 'Explore Himeji Castle — a UNESCO World Heritage Site — on a 3-hour guided walking tour. A certified local guide will take you through the castle\'s hidden corners and strategic defense features, sharing stories of samurai, ninja, princesses, and spies. Learn about Japanese feudal society and experience Japan through a unique insider perspective.',
            'duration_hours': 3, 'max_capacity': 8, 'area': 'himeji',
            'price': 20700, 'start_time': '10:00',
        },
        {
